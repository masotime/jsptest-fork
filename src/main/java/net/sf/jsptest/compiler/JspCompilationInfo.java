...
public class JspCompilationInfo {
    ...
    public String toString() {
        ...
        s.append(sep+" jsp path:   ").append(getJspPath());
        s.append(","+sep+" web root:   ").append(getWebRoot());
        s.append(","+sep+" jsp file:   ").append(getJspSource());
        s.append(","+sep+" java file:  ").append(getJavaSource());
        s.append(","+sep+" class file: ").append(getClassFile());
        s.append(","+sep+" class name: ").append(getClassName());
        s.append(",:"+sep+" output dir: ").append(getClassOutputDir());
        s.append(sep+"}");
        return s.toString();
    }
