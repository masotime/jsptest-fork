...
public class OutputAssertion extends AbstractAssertion {
    ...
    public void shouldContain(String text) {
        String msg = "Rendered output did not contain the expected text <" + text + ">:"+ System.getProperty("line.separator")
                + content;
    ...
    public void shouldNotContain(String text) {
        String msg = "Rendered output contained unexpected text <" + text + ">:"+ System.getProperty("line.separator") + content;
